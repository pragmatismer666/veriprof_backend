<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> User Management <small>Add, Edit/Detail, Delete</small>
        </h1>
    </section>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-sm btn-danger" href="<?php echo base_url() . 'deleteUser/' . $record->userId; ?>" onclick="return confirm('Are you sure you ?');" title="Delete"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                            <?php $i++;
                                }
